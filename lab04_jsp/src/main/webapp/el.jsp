...
<body>
    ...
    <main>
        ...
        o. 스크립트릿 <% ... %> 안에서 사용불가.
        o. 식 <%= ... %> 안에서 사용불가.
        o. JSP 태그를 제외한 JSP 모든 코드 안에서는 사용 가능.
            - HTML 태그의 컨텐트, 속성 값 변경
            - CSS 속성 값 결정
         ...
         o. 상태 저장 메소드: setAttribute("속성이름", 속성값)
         o. 상태 값을 읽는 메소드: getAttribute("속성이름")
          --%>
         <%
         ...
         <p>${ (loginUser != null) ? 'HI!  ' : 'BYE' } ${ loginUser }</p>
    </main>
</body>
</html>