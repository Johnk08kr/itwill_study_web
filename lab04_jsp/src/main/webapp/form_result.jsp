...
<body>
    ...
    <%--
    JSP 내장 객체:
        jsp 파일이 java 코드(파일)로 변환될 때 _jspService(request, response) 메소드 안에서
        선언된 지역 변수들
        scriptlet에서 지역 변수를 선언 할 때 사용할 수 없는 이름들.
        o. request: 클라이언트에서 서버로 보내는 요청 정보들과 메소드를 가지고 있는 객채.
            - getParameter(), ...
        ...
        o. session: 세션이 유지되는 동안 정보를 저장하기 위한 객체. (ex) 로그인 상태 유지
